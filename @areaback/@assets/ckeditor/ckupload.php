<?php 
	//$uweb = "http://localhost/pretty/";
	$uweb = "http://www.prettymcthailand.com/";
	$url = "../../../images/upload/".time()."_".$_FILES['upload']['name'];
	$url2 = "images/upload/".time()."_".$_FILES['upload']['name'];
 ...
 //extensive suitability check before doing anything with the file...
	...
	echo "<script type='text/javascript'>window.parent.CKEDITOR.tools.callFunction($funcNum, '$urlimg', '$message');</script>";
